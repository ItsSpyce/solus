...
template <class T> T GetFunction(LPCSTR name)
{
...
{
  using func_t =
    bool (*)(const char*, ImGuiDataType, void*, int, float, const void*, const void*, const char*, ImGuiSliderFlags);
...
{
  using func_t =
    bool (*)(const char*, const ImVec2, ImGuiDataType, void*, const void*, const void*, const char*, ImGuiSliderFlags);
...
inline ImGuiID DockSpaceOverViewport(ImGuiID dockspace_id = 0,
...
inline void CalcTextSize(ImVec2* pOut,
                         const char* text,
                         const char* text_end,
...
inline ImGuiTableColumnSortSpecs* Create(void)
{
  ...
  func_t func =
    reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiTableColumnSortSpecs_ImGuiTableColumnSortSpecs"));
  return func();
}
...
inline void SetKeyEventNativeData(ImGuiIO* self,
                                  ImGuiKey key,
                                  int native_keycode,
                                  int native_scancode,
...
inline ImGuiInputTextCallbackData* Create(void)
{
  ...
  func_t func =
    reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImGuiInputTextCallbackData_ImGuiInputTextCallbackData"));
  return func();
}
...
inline void PushClipRect(ImDrawList* self,
...
inline void AddRect(ImDrawList* self,
                    const ImVec2 p_min,
                    const ImVec2 p_max,
                    ImU32 col,
                    float rounding,
...
inline void AddRectFilled(ImDrawList* self,
                          const ImVec2 p_min,
                          const ImVec2 p_max,
                          ImU32 col,
                          float rounding,
...
inline void AddRectFilledMultiColor(ImDrawList* self,
                                    const ImVec2 p_min,
                                    const ImVec2 p_max,
                                    ImU32 col_upr_left,
                                    ImU32 col_upr_right,
...
inline void AddQuad(ImDrawList* self,
                    const ImVec2 p1,
                    const ImVec2 p2,
                    const ImVec2 p3,
                    const ImVec2 p4,
...
inline void AddQuadFilled(ImDrawList* self,
                          const ImVec2 p1,
                          const ImVec2 p2,
                          const ImVec2 p3,
                          const ImVec2 p4,
...
inline void AddEllipse(ImDrawList* self,
                       const ImVec2 center,
                       const ImVec2 radius,
                       ImU32 col,
                       float rot,
...
inline void AddEllipseFilled(ImDrawList* self,
                             const ImVec2 center,
                             const ImVec2 radius,
                             ImU32 col,
                             float rot,
...
inline void AddText_FontPtr(ImDrawList* self,
                            const ImFont* font,
                            float font_size,
                            const ImVec2 pos,
                            ImU32 col,
...
{
  using func_t =
    void (*)(ImDrawList*, const ImFont*, float, const ImVec2, ImU32, const char*, const char*, float, const ImVec4*);
...
inline void AddBezierCubic(ImDrawList* self,
                           const ImVec2 p1,
                           const ImVec2 p2,
                           const ImVec2 p3,
                           const ImVec2 p4,
...
inline void AddBezierQuadratic(ImDrawList* self,
                               const ImVec2 p1,
                               const ImVec2 p2,
                               const ImVec2 p3,
                               ImU32 col,
...
inline void AddPolyline(ImDrawList* self,
                        const ImVec2* points,
                        int num_points,
                        ImU32 col,
                        ImDrawFlags flags,
...
inline void AddImage(ImDrawList* self,
                     ImTextureID user_texture_id,
                     const ImVec2 p_min,
                     const ImVec2 p_max,
                     const ImVec2 uv_min,
...
inline void AddImageQuad(ImDrawList* self,
                         ImTextureID user_texture_id,
                         const ImVec2 p1,
                         const ImVec2 p2,
                         const ImVec2 p3,
...
inline void AddImageRounded(ImDrawList* self,
                            ImTextureID user_texture_id,
                            const ImVec2 p_min,
                            const ImVec2 p_max,
                            const ImVec2 uv_min,
...
inline void PathEllipticalArcTo(ImDrawList* self,
                                const ImVec2 center,
                                const ImVec2 radius,
                                float rot,
                                float a_min,
...
inline void PathBezierCubicCurveTo(ImDrawList* self,
                                   const ImVec2 p2,
                                   const ImVec2 p3,
                                   const ImVec2 p4,
                                   int num_segments)
...
inline void PrimRectUV(ImDrawList* self,
                       const ImVec2 a,
                       const ImVec2 b,
                       const ImVec2 uv_a,
                       const ImVec2 uv_b,
...
inline void PrimQuadUV(ImDrawList* self,
                       const ImVec2 a,
                       const ImVec2 b,
                       const ImVec2 c,
                       const ImVec2 d,
...
inline void _PathArcToFastEx(ImDrawList* self,
                             const ImVec2 center,
                             float radius,
                             int a_min_sample,
                             int a_max_sample,
...
inline ImFont* AddFontFromFileTTF(ImFontAtlas* self,
                                  const char* filename,
                                  float size_pixels,
...
inline ImFont* AddFontFromMemoryTTF(ImFontAtlas* self,
                                    void* font_data,
                                    int font_data_size,
                                    float size_pixels,
                                    const ImFontConfig* font_cfg,
...
inline ImFont* AddFontFromMemoryCompressedTTF(ImFontAtlas* self,
...
inline void GetTexDataAsAlpha8(ImFontAtlas* self,
...
inline void GetTexDataAsRGBA32(ImFontAtlas* self,
                               unsigned char** out_pixels,
                               int* out_width,
                               int* out_height,
                               int* out_bytes_per_pixel)
...
inline const ImWchar* GetGlyphRangesChineseSimplifiedCommon(ImFontAtlas* self)
{
  using func_t = const ImWchar* (*) (ImFontAtlas*);
  func_t func =
    reinterpret_cast<func_t>(GetProcAddress(menuFramework, "ImFontAtlas_GetGlyphRangesChineseSimplifiedCommon"));
  return func(self);
}
...
inline int AddCustomRectFontGlyph(ImFontAtlas* self,
                                  ImFont* font,
                                  ImWchar id,
                                  int width,
                                  int height,
...
inline bool GetMouseCursorTexData(ImFontAtlas* self,
...
inline void CalcTextSizeA(ImVec2* pOut,
                          ImFont* self,
                          float size,
                          float max_width,
                          float wrap_width,
...
inline const char* CalcWordWrapPositionA(ImFont* self,
                                         float scale,
                                         const char* text,
                                         const char* text_end,
                                         float wrap_width)
...
inline void RenderText(ImFont* self,
...
inline void AddGlyph(ImFont* self,
...
inline void ImFormatString(char* buf, size_t buf_size, const char* fmt, ...)
{
...
inline int ImTextStrFromUtf8(ImWchar* out_buf,
                             int out_buf_size,
                             const char* in_text,
...
inline void ImBezierCubicClosestPoint(ImVec2* pOut,
                                      const ImVec2 p1,
                                      const ImVec2 p2,
                                      const ImVec2 p3,
                                      const ImVec2 p4,
...
inline void ImBezierCubicClosestPointCasteljau(ImVec2* pOut,
                                               const ImVec2 p1,
                                               const ImVec2 p2,
                                               const ImVec2 p3,
                                               const ImVec2 p4,
...
inline void ImTriangleBarycentricCoords(const ImVec2 a,
                                        const ImVec2 b,
                                        const ImVec2 c,
                                        const ImVec2 p,
                                        float* out_u,
...
inline bool IsWindowChildOf(ImGuiWindow* window,
...
inline void FindHoveredWindowEx(const ImVec2 pos,
...
inline void SetLastItemData(ImGuiID item_id,
...
inline bool BeginChildEx(const char* name,
                         ImGuiID id,
...
inline void FindBestWindowPosForPopupEx(ImVec2* pOut,
...
inline bool BeginViewportSideBar(const char* name,
...
inline void NavMoveRequestSubmit(ImGuiDir move_dir,
                                 ImGuiDir clip_dir,
...
inline void NavMoveRequestForward(ImGuiDir move_dir,
                                  ImGuiDir clip_dir,
                                  ImGuiNavMoveFlags move_flags,
                                  ImGuiScrollFlags scroll_flags)
{
...
inline void DockContextQueueDock(ImGuiContext* ctx,
                                 ImGuiWindow* target,
...
inline ImGuiID DockBuilderSplitNode(ImGuiID node_id,
                                    ImGuiDir split_dir,
...
inline void DockBuilderCopyDockSpace(ImGuiID src_dockspace_id,
...
inline int TypingSelectFindMatch(ImGuiTypingSelectRequest* req,
                                 int items_count,
...
inline int TypingSelectFindNextSingleCharMatch(ImGuiTypingSelectRequest* req,
                                               int items_count,
                                               const char* (*get_item_name_func)(void*, int),
                                               void* user_data,
                                               int nav_item_idx)
...
inline int TypingSelectFindBestLeadingMatch(ImGuiTypingSelectRequest* req,
                                            int items_count,
                                            const char* (*get_item_name_func)(void*, int),
                                            void* user_data)
{
...
inline void TableAngledHeadersRowEx(ImGuiID row_id,
                                    float angle,
...
inline bool BeginTableEx(const char* name,
                         ImGuiID id,
                         int columns_count,
                         ImGuiTableFlags flags,
...
inline bool TabItemEx(ImGuiTabBar* tab_bar,
                      const char* label,
                      bool* p_open,
                      ImGuiTabItemFlags flags,
...
inline void TabItemLabelAndCloseButton(ImDrawList* draw_list,
                                       const ImRect bb,
                                       ImGuiTabItemFlags flags,
...
{
  using func_t =
    void (*)(ImDrawList*, const ImRect, ImGuiTabItemFlags, ImVec2, const char*, ImGuiID, ImGuiID, bool, bool*, bool*);
...
inline void RenderTextClipped(const ImVec2 pos_min,
...
inline void RenderTextClippedEx(ImDrawList* draw_list,
...
inline void RenderTextEllipsis(ImDrawList* draw_list,
                               const ImVec2 pos_min,
                               const ImVec2 pos_max,
                               float clip_max_x,
...
inline void RenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list,
                                                 ImVec2 p_min,
                                                 ImVec2 p_max,
                                                 ImU32 fill_col,
                                                 float grid_step,
...
inline void RenderMouseCursor(ImVec2 pos,
                              float scale,
...
inline void RenderRectFilledRangeH(ImDrawList* draw_list,
                                   const ImRect rect,
                                   ImU32 col,
                                   float x_start_norm,
                                   float x_end_norm,
...
inline void RenderRectFilledWithHole(ImDrawList* draw_list,
                                     const ImRect outer,
                                     const ImRect inner,
                                     ImU32 col,
                                     float rounding)
...
inline bool ImageButtonEx(ImGuiID id,
...
inline bool ScrollbarEx(const ImRect bb,
                        ImGuiID id,
                        ImGuiAxis axis,
                        ImS64* p_scroll_v,
                        ImS64 avail_v,
...
inline bool DragBehavior(ImGuiID id,
                         ImGuiDataType data_type,
                         void* p_v,
                         float v_speed,
                         const void* p_min,
...
inline bool SliderBehavior(const ImRect bb,
                           ImGuiID id,
                           ImGuiDataType data_type,
                           void* p_v,
                           const void* p_min,
                           ...
                           ImRect* out_grab_bb)
{
  using func_t = bool (*)(const ImRect,
                          ImGuiID,
                          ImGuiDataType,
                          void*,
                          const void*,
...
inline bool SplitterBehavior(const ImRect bb,
                             ImGuiID id,
                             ImGuiAxis axis,
                             float* size1,
                             float* size2,
...
inline int DataTypeFormatString(char* buf,
                                int buf_size,
                                ImGuiDataType data_type,
                                const void* p_data,
                                const char* format)
...
inline bool DataTypeApplyFromText(const char* buf,
                                  ImGuiDataType data_type,
                                  void* p_data,
                                  const char* format,
...
inline bool InputTextEx(const char* label,
                        const char* hint,
                        char* buf,
                        int buf_size,
                        const ImVec2 size_arg,
...
{
  using func_t =
    bool (*)(const char*, const char*, char*, int, const ImVec2, ImGuiInputTextFlags, ImGuiInputTextCallback, void*);
...
inline bool TempInputText(const ImRect bb,
                          ImGuiID id,
                          const char* label,
                          char* buf,
                          int buf_size,
...
inline bool TempInputScalar(const ImRect bb,
                            ImGuiID id,
                            const char* label,
                            ImGuiDataType data_type,
                            void* p_data,
...
inline int PlotEx(ImGuiPlotType plot_type,
                  const char* label,
                  float (*values_getter)(void* data, int idx),
                  void* data,
                  int values_count,
                  ...
                  const ImVec2 size_arg)
{
  using func_t = int (*)(ImGuiPlotType,
                         const char*,
                         float (*)(void*, int),
                         void*,
                         int,
...
inline void ShadeVertsLinearColorGradientKeepAlpha(ImDrawList* draw_list,
                                                   int vert_start_idx,
                                                   int vert_end_idx,
                                                   ImVec2 gradient_p0,
                                                   ImVec2 gradient_p1,
...
inline void ShadeVertsLinearUV(ImDrawList* draw_list,
                               int vert_start_idx,
                               int vert_end_idx,
                               const ImVec2 a,
                               const ImVec2 b,
...
inline void ShadeVertsTransformPos(ImDrawList* draw_list,
                                   int vert_start_idx,
                                   int vert_end_idx,
...
inline void ErrorCheckUsingSetCursorPosToExtendParentBoundaries()
{
  using func_t = void (*)();
  func_t func =
    reinterpret_cast<func_t>(GetProcAddress(menuFramework, "igErrorCheckUsingSetCursorPosToExtendParentBoundaries"));
  return func();
}
...
inline void DebugNodeDrawList(ImGuiWindow* window,
                              ImGuiViewportP* viewport,
...
inline void DebugNodeWindowsListByBeginStackParent(ImGuiWindow** windows,
                                                   int windows_size,
...
inline void ImFontAtlasBuildSetupFont(ImFontAtlas* atlas,
                                      ImFont* font,
...
inline void ImFontAtlasBuildRender8bppRectFromString(ImFontAtlas* atlas,
                                                     int x,
                                                     int y,
                                                     int w,
                                                     int h,
...
inline void ImFontAtlasBuildRender32bppRectFromString(ImFontAtlas* atlas,
                                                      int x,
                                                      int y,
                                                      int w,
                                                      int h,
